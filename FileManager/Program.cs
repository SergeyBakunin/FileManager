...
namespace FileManager
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            DrawWidow(0, 0, WINDOW_WIDTH, 18);
            DrawWidow(0, 18, WINDOW_WIDTH, 8);
            UpdateConsole();
        ...
        /// <summary>
        /// Вспомогательный метод, чтобы получить текущую позицию курсора
        /// </summary>
        /// <returns></returns>
        ...
        static void ProccessEnterCommand(int width)
        {
            //TODO: ...
        ...
        /// <param name="width">Ширина области ввода</param>
        /// <param name="height">Высота области ввода</param>
        static void DrawConsole(string dir, int x, int y, int width, int height)
        {
            DrawWidow(x, y, width, height);
        ...
        static void DrawWidow(int x, int y, int width, int height)
        {
            // header - шапка
